...
For the Sad Servers task **Command Line Murders** the objective was to identify the murderer using the available clues. By analyzing these clues, I navigated through different directories and files, applying various Linux commands to uncover information. Gradually, this systematic investigation led to discovering the culprit.
...
The objective of this task was to build a basic **Webapp** using Express.js.The **Mini Expense Tracker** allows users to add and manage their daily expenses across different categories like Food, Entertainment, Shopping, and Transport. Users can view, edit, and track spending to monitor their budget effectively.
